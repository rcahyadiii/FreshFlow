-- Notifications and notification settings keyed by username (dev-friendly)
...
-- Simple per-user notification delivery preferences
...
-- Optional convenience upsert for settings
